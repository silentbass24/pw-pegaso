    ...
    ***************************************************************************** */
    ...
    var JqxRepeatButton = /** @class */ (function (_super) {
        ...
        function JqxRepeatButton(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxRepeatButton' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxRepeatButton.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxRepeatButton('destroy');
            }
            catch (e) {
