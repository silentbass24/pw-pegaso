    ...
    ***************************************************************************** */
    ...
    var JqxMaskedInput = /** @class */ (function (_super) {
        ...
        function JqxMaskedInput(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxMaskedInput' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxMaskedInput.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxMaskedInput('destroy');
            }
            catch (e) {
