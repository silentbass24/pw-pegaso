    ...
    ***************************************************************************** */
    ...
    var JqxProgressBar = /** @class */ (function (_super) {
        ...
        function JqxProgressBar(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxProgressBar' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxProgressBar.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxProgressBar('destroy');
            }
            catch (e) {
