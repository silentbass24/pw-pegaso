...
var JqxListBox = /** @class */ (function (_super) {
    ...
    function JqxListBox(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxListBox' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxListBox.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
