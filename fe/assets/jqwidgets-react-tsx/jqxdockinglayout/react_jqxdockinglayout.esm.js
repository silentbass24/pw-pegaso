...
var JqxDockingLayout = /** @class */ (function (_super) {
    ...
    function JqxDockingLayout(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxDockingLayout' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxDockingLayout.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxDockingLayout('destroy');
        }
        catch (e) {
