    ...
    ***************************************************************************** */
    ...
    var JqxNumberInput = /** @class */ (function (_super) {
        ...
        function JqxNumberInput(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxNumberInput' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxNumberInput.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxNumberInput('destroy');
            }
            catch (e) {
