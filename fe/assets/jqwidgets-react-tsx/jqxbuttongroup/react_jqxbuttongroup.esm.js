...
var JqxButtonGroup = /** @class */ (function (_super) {
    ...
    function JqxButtonGroup(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxButtonGroup' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxButtonGroup.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxButtonGroup('destroy');
        }
        catch (e) {
