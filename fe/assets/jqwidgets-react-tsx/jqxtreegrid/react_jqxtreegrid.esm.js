...
var JqxTreeGrid = /** @class */ (function (_super) {
    ...
    function JqxTreeGrid(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxTreeGrid' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxTreeGrid.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
