...
var JqxBulletChart = /** @class */ (function (_super) {
    ...
    function JqxBulletChart(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxBulletChart' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxBulletChart.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxBulletChart('destroy');
        }
        catch (e) {
