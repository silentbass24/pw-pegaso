    ...
    ***************************************************************************** */
    ...
    var JqxToggleButton = /** @class */ (function (_super) {
        ...
        function JqxToggleButton(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxToggleButton' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxToggleButton.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxToggleButton('destroy');
            }
            catch (e) {
