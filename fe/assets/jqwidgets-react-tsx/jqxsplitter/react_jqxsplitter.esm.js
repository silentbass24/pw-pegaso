...
var JqxSplitter = /** @class */ (function (_super) {
    ...
    function JqxSplitter(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxSplitter' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxSplitter.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
