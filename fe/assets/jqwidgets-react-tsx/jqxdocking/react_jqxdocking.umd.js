    ...
    ***************************************************************************** */
    ...
    var JqxDocking = /** @class */ (function (_super) {
        ...
        function JqxDocking(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxDocking' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxDocking.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
