...
var JqxPopover = /** @class */ (function (_super) {
    ...
    function JqxPopover(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxPopover' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxPopover.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
