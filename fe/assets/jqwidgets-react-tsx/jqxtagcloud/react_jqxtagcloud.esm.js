...
var JqxTagCloud = /** @class */ (function (_super) {
    ...
    function JqxTagCloud(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxTagCloud' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxTagCloud.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
