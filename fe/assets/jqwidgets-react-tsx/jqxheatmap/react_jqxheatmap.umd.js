    ...
    ***************************************************************************** */
    ...
    var JqxHeatMap = /** @class */ (function (_super) {
        ...
        function JqxHeatMap(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxHeatMap' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxHeatMap.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
