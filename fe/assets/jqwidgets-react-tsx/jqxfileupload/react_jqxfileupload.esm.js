...
var JqxFileUpload = /** @class */ (function (_super) {
    ...
    function JqxFileUpload(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxFileUpload' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxFileUpload.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
