...
var JqxTextArea = /** @class */ (function (_super) {
    ...
    function JqxTextArea(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxTextArea' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxTextArea.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
