    ...
    ***************************************************************************** */
    ...
    var JqxTreeMap = /** @class */ (function (_super) {
        ...
        function JqxTreeMap(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxTreeMap' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxTreeMap.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
