...
var JqxCheckBoxGroup = /** @class */ (function (_super) {
    ...
    function JqxCheckBoxGroup(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxCheckBoxGroup' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxCheckBoxGroup.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxCheckBoxGroup('destroy');
        }
        catch (e) {
