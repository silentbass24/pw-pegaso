    ...
    ***************************************************************************** */
    ...
    var JqxExpander = /** @class */ (function (_super) {
        ...
        function JqxExpander(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxExpander' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxExpander.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
