    ...
    ***************************************************************************** */
    ...
    var JqxDropDownButton = /** @class */ (function (_super) {
        ...
        function JqxDropDownButton(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxDropDownButton' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxDropDownButton.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxDropDownButton('destroy');
            }
            catch (e) {
