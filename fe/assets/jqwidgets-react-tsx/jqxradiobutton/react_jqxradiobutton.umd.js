    ...
    ***************************************************************************** */
    ...
    var JqxRadioButton = /** @class */ (function (_super) {
        ...
        function JqxRadioButton(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxRadioButton' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxRadioButton.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
            ...
            try {
                element.jqxRadioButton('destroy');
            }
            catch (e) {
