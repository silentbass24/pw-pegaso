...
var JqxComplexInput = /** @class */ (function (_super) {
    ...
    function JqxComplexInput(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxComplexInput' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxComplexInput.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxComplexInput('destroy');
        }
        catch (e) {
