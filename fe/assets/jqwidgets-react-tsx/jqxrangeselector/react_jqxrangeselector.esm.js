...
var JqxRangeSelector = /** @class */ (function (_super) {
    ...
    function JqxRangeSelector(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxRangeSelector' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxRangeSelector.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxRangeSelector('destroy');
        }
        catch (e) {
