...
var JqxToolBar = /** @class */ (function (_super) {
    ...
    function JqxToolBar(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxToolBar' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxToolBar.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
