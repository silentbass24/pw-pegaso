    ...
    ***************************************************************************** */
    ...
    var JqxScrollBar = /** @class */ (function (_super) {
        ...
        function JqxScrollBar(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxScrollBar' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxScrollBar.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
