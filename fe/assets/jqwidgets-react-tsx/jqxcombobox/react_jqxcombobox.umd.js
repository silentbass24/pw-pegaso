    ...
    ***************************************************************************** */
    ...
    var JqxComboBox = /** @class */ (function (_super) {
        ...
        function JqxComboBox(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxComboBox' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxComboBox.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
