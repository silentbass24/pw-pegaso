...
var JqxFormattedInput = /** @class */ (function (_super) {
    ...
    function JqxFormattedInput(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxFormattedInput' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxFormattedInput.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxFormattedInput('destroy');
        }
        catch (e) {
