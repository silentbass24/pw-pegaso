    ...
    ***************************************************************************** */
    ...
    var JqxSortable = /** @class */ (function (_super) {
        ...
        function JqxSortable(props) {
            ...
            _this._jqx = JQXLite;
            _this._id = 'JqxSortable' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
        ...
        JqxSortable.prototype.componentWillUnmount = function () {
            if (!this._jqx) {
                return;
            }
