...
var JqxDataTable = /** @class */ (function (_super) {
    ...
    function JqxDataTable(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxDataTable' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxDataTable.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
