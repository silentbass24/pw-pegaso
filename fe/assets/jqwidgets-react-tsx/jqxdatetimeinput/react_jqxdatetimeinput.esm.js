...
var JqxDateTimeInput = /** @class */ (function (_super) {
    ...
    function JqxDateTimeInput(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxDateTimeInput' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxDateTimeInput.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxDateTimeInput('destroy');
        }
        catch (e) {
