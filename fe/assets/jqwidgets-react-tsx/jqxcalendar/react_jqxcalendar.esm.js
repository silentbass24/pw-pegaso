...
var JqxCalendar = /** @class */ (function (_super) {
    ...
    function JqxCalendar(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxCalendar' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxCalendar.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
