...
var JqxResponsivePanel = /** @class */ (function (_super) {
    ...
    function JqxResponsivePanel(props) {
        ...
        _this._jqx = JQXLite;
        _this._id = 'JqxResponsivePanel' + (_this._jqx ? _this._jqx.generateID() : 'SSR' + (++__ssrIdCounter__));
    ...
    JqxResponsivePanel.prototype.componentWillUnmount = function () {
        if (!this._jqx) {
            return;
        }
        ...
        try {
            element.jqxResponsivePanel('destroy');
        }
        catch (e) {
