                    ...
                    <JqxTree ref="myTree" @select="onTreeSelect($event)"
                        ...
                        <ul>
                            <li item-expanded="true" id="t1">
                                <img src="img/contactsIcon.png" /><span item-title="true">News and Blogs</span>
                                <ul>
                                    <li>
                                        <img src="img/favorites.png" /><span item-title="true">Favorites</span>
                                        <ul>
                                            <li>
                                                <img src="img/folder.png" /><span item-title="true">ScienceDaily</span>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <img src="img/folder.png" /><span item-title="true">Geek.com</span>
                                    </li>
                                    <li>
                                        <img src="img/folder.png" /><span item-title="true">CNN.com</span>
                                    </li>
                                </ul>
                            </li>
                        </ul>
        ...
        data: function () {
            return {
                config: {
                    ...
                    format: 'txt',
                    dataDir: '.',   // the feeds ship beside index.htm
