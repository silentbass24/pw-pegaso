            ...
            <div class="jqx-rc-all slider-demo-content-inner">
                <div class="jqx-rc-all slider-demo-content-container">
                    <div id="navigationContainer" class="slider-demo-content-navigation">
                        <img src="img/previous.png" class="slider-demo-navigation-item" alt="Previous"
                             title="Previous" id="previousButton" />
                        <img src="img/play.png" class="slider-demo-navigation-item" alt="Play" title="Play"
                             id="playButton" />
                        <img src="img/stop.png" class="slider-demo-navigation-item" alt="Stop" title="Stop"
                             id="stopButton" />
                        <img src="img/next.png" class="slider-demo-navigation-item" alt="Next" title="Next"
...
<style>
    ...
    .slider-demo-header {
        background-image: url(img/slider-demo-header-background.png);
        width: 665px;
        height: 76px;
    }
