<template>
    <div>
        <JqxScrollView :width="500" :height="350" :slideShow='true' :showButtons='false'>
            <div>
                <div class="photo" style="background-image: url(img/imageNature1.jpg)"></div>
            </div>
            <div>
                <div class="photo" style="background-image: url(img/imageNature2.jpg)"></div>
            </div>
            <div>
                <div class="photo" style="background-image: url(img/imageNature3.jpg)"></div>
            </div>
            <div>
                <div class="photo" style="background-image: url(img/imageNature4.jpg)"></div>
            </div>
            <div>
                <div class="photo" style="background-image: url(img/imageNature5.jpg)"></div>
            </div>
        </JqxScrollView>
