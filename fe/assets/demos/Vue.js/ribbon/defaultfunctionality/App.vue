                        ...
                        <tr>
                            <td class="bigTd">
                                <JqxButton class='button left' :theme="'demoTheme'" :width="36" :height="36">
                                    <img class="img" src="img/help-26.png" />
                                </JqxButton>
                                Help
                            </td>
                            <td class="bigTd">
                                <JqxButton class='button left' :theme="'demoTheme'" :width="36" :height="36">
                                    <img class="img" src="img/about-26.png" />
                                </JqxButton>
                                About
                            </td>
                            <td class="bigTd">
                                <JqxButton class="button left" :theme="'demoTheme'" :width="36" :height="36">
                                    <img class="img" src="img/downloading_updates-26.png" />
                                </JqxButton>
                                Update
                            </td>
                        </tr>
...
<style>
    ...
    .icon {
        background: url('img/ribbon-icons.png') no-repeat top left;
        width: 16px;
        height: 16px;
        display: inline-block;
        margin-right: 2px;
