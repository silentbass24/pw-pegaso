<template>
    <div id="jqxWidget">
        ...
        <JqxWindow ref="window"
            ...
            <div>
                <span>
                    <img src="img/movie.png" alt="" style="margin-right: 15px" />Movies
                </span>
            </div>
            <div>
                <JqxTabs ref="tab" :autoCreate="false">
                    ...
                    <div>
                        <img src="img/avatar.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="img/endgame.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="img/twilight.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="img/unstoppable.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="img/priest.png" style="float: left; margin: 10px;" alt="" />
