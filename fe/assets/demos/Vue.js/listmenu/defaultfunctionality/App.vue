<template>
    <JqxListMenu :autoSeparators="true"
        ...
        <ul data-role="listmenu">
            <li>
                <img src="img/andrew.png" alt="" /><div>
                    Andrew Fuller
                </div>
                <ul data-role="listmenu">
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/andrew.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Andrew Fuller</b>
                                    </td>
                    ...
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/anne.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Anne Dodsworth</b>
                                    </td>
                    ...
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/janet.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Janet Leverling</b>
                                    </td>
                    ...
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/laura.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Laura Callahan</b>
                                    </td>
            ...
            <li>
                <img src="img/margaret.png" alt="" /><div>
                    Margaret Peacock
                </div>
                <ul data-role="listmenu">
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/margaret.png" alt="" />
                                    </td>
                                    <td>
            ...
            <li>
                <img src="img/michael.png" alt="" /><div>
                    Michael Suyama
                </div>
                <ul data-role="listmenu">
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/michael.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Michael Suyama</b>
                                    </td>
                    ...
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/nancy.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Nancy Davolio</b>
                                    </td>
            ...
            <li>
                <img src="img/robert.png" alt="" /><div>
                    Robert King
                </div>
                <ul data-role="listmenu">
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/robert.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Robert King</b>
                                    </td>
            ...
            <li>
                <img src="img/steven.png" alt="" /><div>
                    Steven Buchanan
                </div>
                <ul data-role="listmenu">
                    <li>
                        <div style="padding: 5px;" data-role="content">
                            <table>
                                <tr>
                                    <td>
                                        <img width="50" height="50" src="img/steven.png" alt="" />
                                    </td>
                                    <td>
                                        <b>Steven Buchanan</b>
                                    </td>
