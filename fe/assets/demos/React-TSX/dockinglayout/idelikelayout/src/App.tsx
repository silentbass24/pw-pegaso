...
const App = () => {
    ...
    const viewServerExplorerBtnOnClick = useCallback((): void => {
        myDockingLayout.current!.addFloatGroup(300, 200, { x: 500, y: 200 }, 'layoutPanel', 'Server Explorer', '<div id="serverExplorerTree" style="width: 100%; height: 100%" />',
            (): void => {
                const source = [{
                    expanded: true,
                    icon: '/img/dataadapter.png',
                    items: [{
                        icon: '/img/validator.png',
                    ...
                    items: [{
                        ...
                        icon: '/img/dragdrop.png',
                        label: 'SharePoint Connections'
                    }],
                    label: 'Servers'
                }];

                renderInto(<JqxTree width={'99%'} height={'99%'} source={source} />, document.querySelector('#serverExplorerTree'));
            }
        );
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        initContent: () => {
                            renderInto(<JqxTextArea ref={textArea1} width={'100%'} height={400} />, document.querySelector('#Document1TextArea'), () => {
                        ...
                        initContent: () => {
                            renderInto(<JqxTextArea width={'100%'} height={400} placeHolder={'Blank document'} />, document.querySelector('#Document2TextArea'));
                        },
                        title: 'New Document',
                        type: 'documentPanel'
                    }],
                ...
                items: [{
                    ...
                    initContent: () => {
                        ...
                        renderInto(<JqxTree width={'100%'} height={'99%'} source={source} />, document.querySelector('#solutionExplorerTree'));
                    },
    ...
    return (
        <div>
            <JqxDockingLayout theme={'material-purple'} Layout ref={myDockingLayout}
                // @ts-ignore
                width={'100%'} height={600} layout={layout}>
            ...
            <JqxButton theme={'material-purple'} ref={viewServerExplorerBtn} width={160}
