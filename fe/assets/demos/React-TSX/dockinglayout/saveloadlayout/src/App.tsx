...
const App = () => {
    ...
    const loadLayoutButton = useRef<JqxButton>(null);
    const savedLayout = useRef<any>(undefined as any);
    ...
    const loadBtnOnClick = useCallback((): void => {
                    ...
                    items: [
                        {
                            ...
                            initContent: () => {
                                ...
                                renderInto(<JqxTree width={'100%'} height={'99%'} source={source} />, document.querySelector('#treeContainer'));
                            },
    ...
    return (
        // @ts-ignore
        <div>
            <JqxDockingLayout theme={'material-purple'} ref={myDockingLayout}
                // @ts-ignore
            ...
            <div style={{ marginTop: '25px' }}>
                <JqxButton theme={'material-purple'} style={{ float: 'left', marginRight: '10px' }}
                    onClick={saveBtnOnClick} width={90}>
                    Save Layout
                </JqxButton>

                <JqxButton theme={'material-purple'} ref={loadLayoutButton} style={{ float: 'left' }}
                    onClick={loadBtnOnClick} width={90}>
                    Load Layout
                </JqxButton>
            </div>
        </div>
