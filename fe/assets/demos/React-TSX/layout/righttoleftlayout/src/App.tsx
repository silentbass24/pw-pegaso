...
const App = () => {
    const source = useMemo(() => [{
        ...
        items: [{
            ...
            icon: '/img/folder.png',
            items: [
                { icon: '/img/nav1.png', label: 'jqx.base.css' },
                { icon: '/img/nav1.png', label: 'jqx.energyblue.css' },
                { icon: '/img/nav1.png', label: 'jqx.orange.css' }
            ],
            label: 'css'
        }, {
            icon: '/img/folder.png',
            items: [
                { icon: '/img/nav1.png', label: 'jqxcore.js' },
                { icon: '/img/nav1.png', label: 'jqxdata.js' },
                { icon: '/img/nav1.png', label: 'jqxgrid.js' }
            ],
            label: 'scripts'
        }, {
            icon: '/img/nav1.png',
    ...
    useEffect(() => {
        ...
        return () => {
            if (treeContainerRef.current) {
                unmountFrom(treeContainerRef.current);
            }
        }
    }, [source]);
