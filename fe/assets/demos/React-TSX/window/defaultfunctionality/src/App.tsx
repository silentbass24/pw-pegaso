        ...
        <div ref={jqxWidget}>
            ...
            <div style={{ width: '100%', height: 650, marginTop: 50 }}>
                ...
                >
                    <div>
                        <span>
                            <img src="/img/movie.png" alt="" style={{ marginRight: '15px' }} />Movies
                        </span>
                    </div>
                    <div style={{ overflow: 'hidden' }}>
                        <JqxTabs theme={'material-purple'} width={'100%'} height={'100%'}>
                            ...
                            <div>
                                <img src="/img/avatar.png" style={tabsStyle} alt="" />
                            ...
                            <div>
                                <img src="/img/endgame.png" style={tabsStyle} alt="" />
                            ...
                            <div>
                                <img src="/img/twilight.png" style={tabsStyle} alt="" />
                            ...
                            <div>
                                <img src="/img/unstoppable.png" style={tabsStyle} alt="" />
                            ...
                            <div>
                                <img src="/img/priest.png" style={tabsStyle} alt="" />
