        ...
        <div>
            ...
            >
                ...
                <div style={{ textAlign: 'right', direction: 'rtl' }}>
                    <img src="/img/avatar.png" style={{ float: 'right', margin: 10 }} alt="" />
                ...
                <div style={{ textAlign: 'right', direction: 'rtl' }}>
                    <img src="/img/endgame.png" style={{ float: 'right', margin: 10 }} alt="" />
                ...
                <div style={{ textAlign: 'right', direction: 'rtl' }}>
                    <img src="/img/twilight.png" style={{ float: 'right', margin: 10 }} alt="" />
                ...
                <div style={{ textAlign: 'right', direction: 'rtl' }}>
                    <img src="/img/unstoppable.png" style={{ float: 'right', margin: 10 }} alt="" />
                ...
                <div style={{ textAlign: 'right', direction: 'rtl' }}>
                    <img src="/img/priest.png" style={{ float: 'right', margin: 10 }} alt="" />
