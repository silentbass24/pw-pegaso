...
const App = () => {
    ...
    const checkedLeft = useCallback((event: any): void => {
        myTabs.current!.setOptions({ scrollPosition: 'left' });
    }, []);

    const checkedRight = useCallback((event: any): void => {
    ...
    return (
        <div>
            ...
            <div style={{ float: "left", marginLeft: 50 }}>
                ...
                <JqxRadioButton theme={'material-purple'} onChecked={checkedLeft} height={height} width={width}>
                    Left
                </JqxRadioButton>
                <JqxRadioButton theme={'material-purple'} onChecked={checkedRight} height={height} width={width}>
                    Right
                </JqxRadioButton>
                <JqxRadioButton theme={'material-purple'} onChecked={checkedBoth} height={height} width={width}>
                    Both
                </JqxRadioButton>
            </div >
        </div>
