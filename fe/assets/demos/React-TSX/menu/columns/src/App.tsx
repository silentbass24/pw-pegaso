...
function App() {
    useEffect(() => {
        renderInto(<JqxButton width={60} height={23} value={'Search'} />, document.getElementsByClassName('jqx-menu-search')[0]);
        renderInto(<JqxButton width={150} height={25} value={'Buy Online'} />, document.getElementsByClassName('buyonline')[0]);
    }, []);
