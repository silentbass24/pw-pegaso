...
const App = () => {
    const timeOut = useRef<any>(setTimeout(() => { /* */ }, 1000));
    ...
    const change = useCallback((event: any): void => {
        carPreview().loadSlide(event.args.value);
    }, []);

    useEffect(() => {
        (document.getElementsByClassName('slider-demo-header')[0] as HTMLElement).style.backgroundImage = "url('/img/slider-demo-header-background.png')";
        ...
        <div className="jqx-rc-all slider-demo-main">
            ...
            <div className="jqx-rc-b slider-demo-content">
                <div className="jqx-rc-all slider-demo-content-inner">
                    <div className="jqx-rc-all slider-demo-content-container">
                        <div id="navigationContainer" className="slider-demo-content-navigation">
                            <img src="/img/previous.png" className="slider-demo-navigation-item" alt="Previous"
                                title="Previous" id="previousButton" />
                            <img src="/img/play.png" className="slider-demo-navigation-item" alt="Play" title="Play"
                                id="playButton" />
                            <img src="/img/stop.png" className="slider-demo-navigation-item" alt="Stop" title="Stop"
                                id="stopButton" />
                            <img src="/img/next.png" className="slider-demo-navigation-item" alt="Next" title="Next"
                ...
                <div className="slider-demo-slider-container">
                    <JqxSlider theme={'material-purple'} ref={mySlider}
                        onChange={change}
                        height={250}
                        width={36}
