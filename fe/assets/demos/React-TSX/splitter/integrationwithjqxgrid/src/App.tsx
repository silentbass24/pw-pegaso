...
const App = () => {
    ...
    const saveClick = useCallback((): void => {
    ...
    const expanded = useCallback((event: any): void => {
            ...
            <div ref={ContentPanel}>
                <form>
                    <table style={{ marginTop: 20, width: "100%" }}>
                        <tbody>
                            <Field reference={CompanyName} name={"Company Name:"} height={height} />
                            <Field reference={ContactName} name={"Contact Name:"} height={height} />
                            <Field reference={ContactTitle} name={"Contact Title:"} height={height} />
                            <Field reference={City} name={"City:"} height={height} />
                            <Field reference={Country} name={"Country:"} height={height} />
                            <tr>
                                <td />
                                <td style={{ paddingLeft: 35, textAlign: "left" }}>
                                    <JqxButton theme={'material-purple'} onClick={saveClick}
                                        width={70}>
                                        Save
                                    </JqxButton>
                                </td>
