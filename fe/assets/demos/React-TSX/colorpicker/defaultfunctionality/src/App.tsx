    ...
    return (
        <div>
            <JqxScrollView theme={'material-purple'} width={500} height={350} slideShow={true} showButtons={false}>
                <div>
                    <div className="photo" style={{ backgroundImage: 'url(/img/imageNature1.jpg)' }} />
                </div>
                <div>
                    <div className="photo" style={{ backgroundImage: 'url(/img/imageNature2.jpg)' }} />
                </div>
                <div>
                    <div className="photo" style={{ backgroundImage: 'url(/img/imageNature3.jpg)' }} />
                </div>
                <div>
                    <div className="photo" style={{ backgroundImage: 'url(/img/imageNature4.jpg)' }} />
                </div>
                <div>
                    <div className="photo" style={{ backgroundImage: 'url(/img/imageNature5.jpg)' }} />
                </div>
            </JqxScrollView>
