...
import JqxButton, { JQXLite } from 'jqwidgets-scripts/jqwidgets-react-tsx/jqxbuttons';
...
const App = () => {
    ...
    const itemsInCart: number = 0;

        const data: any[] = [
            {
                laptops:
                    [
                        { img: '/img/l-13.jpg', ram: '8GB DD3', cpu: 'Intel Core i7-3720QM', price: 2999, display: 15.4, hdd: '512GB SSD', model: 'Apple MacBook Pro' },
            ...
            },
            {
                laptops:
                    [
                        ...
                        { img: '/img/l-24.jpg', ram: '8GB DD3', cpu: 'Intel Core i7-4500U', price: 1599, display: 15.6, hdd: '256GB SSD', model: 'Acer Aspire V5-573G' }
                    ]
            },
            {
                laptops:
                    [
                        ...
                        { img: '/img/l-27.jpg', ram: '8GB DD3', cpu: 'Intel Core i5-3317U ', price: 1699, display: 12.5, hdd: '128GB SSD', model: 'Dell XPS Duo 12' }
                    ]
            },
            {
                laptops:
                    [
                        { img: '/img/l-28.png', ram: '8GB DD3', cpu: 'Intel Core i7-3537U', price: 1799, display: 12.5, hdd: '256GB SSD', model: 'Lenovo ThinkPad Twist S230u' },
        ...
        const rendered = (): void => {
            const clickHandler = () => {
                itemsInCart++;
                productNumber.current!.innerHTML = `${itemsInCart} products`;
            };
            const buyElements = document.getElementsByClassName('buy');
            // The button is created straight on the cell rather than through a
            // React root: the DataTable rebuilds these cells on every render, and
            // a root mounts too late for the widget to find its own element.
            Array.prototype.forEach.call(buyElements, (element: HTMLDivElement) => {
                if (element.getAttribute('data-wired') === 'true') { return; }
                element.setAttribute('data-wired', 'true');
                const button = document.createElement('div');
                element.appendChild(button);
                JQXLite(button).jqxButton({ width: 80, value: 'Buy' });
    ...
    return (
        ...
        <br />
            <JqxDataTable theme={'material-purple'}
                ...
                rendered={rendered} altRows={true} pageable={true} sortable={true} pageSize={2}
