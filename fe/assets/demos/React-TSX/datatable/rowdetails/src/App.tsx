...
const App = () => {
    ...
    useEffect(() => {
        myDataTable.current!.showDetails(0);
    }, []);
    ...
    return (
        <JqxDataTable theme={'material-purple'} ref={myDataTable}
            ...
            columns={columns} rowDetails={true} pageable={true}
            sortable={true} pageSize={3} initRowDetails={initRowDetails} />
    );
};
