...
function App() {
    ...
    function updateLog(currentObsArr: any): void {
        let rows = '';
        // a jqx.observableArray is array-like, not iterable: index it
        for (let i = 0; i < currentObsArr.length; i++) {
            rows += currentObsArr.toJSON(['firstname', 'lastname', 'productname', 'quantity', 'price', 'total'], currentObsArr[i]);
            rows += '<br/>';
        }
