...
const App = () => {
    ...
    return (
        <div>
            <JqxGrid theme={'material-purple'} ref={myGrid}
                onCellselect={myGridOnCellSelect} onCellendedit={myGridOnCellEndEdit}
                width={600} source={source} columns={columns}
                editable={true} autoheight={true} selectionmode={'singlecell'} />

            <div ref={eventLog} style={{ fontSize: '13px', marginTop: '20px', fontFamily: 'Verdana' }} />
        </div>
    );
};
