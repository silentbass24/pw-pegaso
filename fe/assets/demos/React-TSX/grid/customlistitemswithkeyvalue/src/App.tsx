...
const App = () => {
    ...
    const myGridOnFilter = useCallback((): void => {
        ...
        eventLog.current!.innerHTML = JSON.stringify(data);
    }, []);
        ...
        const sourceData: any = {
            datafields: [
                ...
                // value - the field's value in the data sourceData.
                // values - specifies the field's values.
                // values.source - specifies the foreign sourceData. The expected value is an array.
                // values.value - specifies the field's value in the foreign sourceData.
                // values.name - specifies the field's name in the foreign sourceData.
    ...
    return (
        <div>
            <JqxGrid theme={'material-purple'} ref={myGrid} onFilter={myGridOnFilter}
                width={600} source={source} columns={columns}
                filterable={true} showfilterrow={true} />

            <div ref={eventLog} style={{ fontSize: '13px', width: '800px', maxWidth: '800px', overflow: 'auto', marginTop: '20px', fontFamily: 'Verdana' }} />
        </div>
    );
};
