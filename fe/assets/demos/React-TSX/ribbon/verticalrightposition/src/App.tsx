    ...
    return (
        <div>
            <div style={{ width: '450px' }}>
                <JqxRibbon theme={'material-purple'} ref={myRibbon} style={{ float: 'right' }}
                        ...
                        <div>
                            ...
                            <div className="container">
                                <table><tbody>
                                    ...
                                    <tr>
                                        <td className="image">
                                            <img src={'/img/Samsung-Galaxy-S4.png'} />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="name">
                        ...
                        <div>
                            ...
                            <div className="container">
                                <table><tbody>
                                    ...
                                    <tr>
                                        <td className="image">
                                            <img src={'/img/l-25.jpg'} style={{ width: '140px', height: '105px' }} />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="name">
            ...
            <JqxCheckBox theme={'material-purple'} style={{ marginTop: '50px' }} onChange={onChange}>Menu Mode</JqxCheckBox>
        </div>
    );
};
