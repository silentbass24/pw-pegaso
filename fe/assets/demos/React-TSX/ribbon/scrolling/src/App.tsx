...
const App = () => {
    ...
    const checkedNear = useCallback((event: any): void => {
        myRibbon.current!.setOptions({ scrollPosition: 'near' });
    }, []);

    const checkedFar = useCallback((event: any): void => {
        myRibbon.current!.setOptions({ scrollPosition: 'far' });
    }, []);

    const checkedBoth = useCallback((event: any): void => {
        myRibbon.current!.setOptions({ scrollPosition: 'both' });
    }, []);

    return (
        <div>
            <JqxRibbon theme={'material-purple'} ref={myRibbon} style={{ float: 'left' }}
            ...
            <div style={{ width: '200px', float: 'left', marginLeft: '30px' }}>
                ...
                <JqxRadioButton theme={'material-purple'} width={100} height={25} onChecked={checkedNear}>
                    Near
                </JqxRadioButton>
                <JqxRadioButton theme={'material-purple'} width={100} height={25} onChecked={checkedFar}>
                    Far
                </JqxRadioButton>
                <JqxRadioButton theme={'material-purple'} width={500} height={25} checked={true} onChecked={checkedBoth} >
                    Both
                </JqxRadioButton>
            </div>
        </div>
