...
function App() {
    ...
    const renderAppointment = React.useCallback((data: any) => {
        let img = '<img style="top: 2px; position: relative;" src="/img/person.png"/>';
        if (data.appointment.subject === 'Nancy') {
            img = '<img style="top: 2px; position: relative;" src="/img/woman.png"/>';
        }
        else if (data.appointment.subject === 'Peter') {
            img = '<img style="top: 2px; position: relative;" src="/img/boss.png"/>';
        }
        else if (data.appointment.subject === 'Antony') {
            img = '<img style="top: 2px; position: relative;" src="/img/oldboss.png"/>';
        }
        else if (data.appointment.subject === 'John') {
            img = '<img style="top: 2px; position: relative;" src="/img/asian.png"/>';
        }
