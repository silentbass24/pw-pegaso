...
export class AppComponent implements AfterViewInit {
    ...
    updateSeriesGroupsVisibility(): void {
        ...
        if (!this.btnEnableSeriesGroup1 || !this.btnEnableSeriesGroup2) { return; }
    ...
    updateSeriesGroupsStacking(): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.btnEnableSeriesGroup1 || !this.btnEnableSeriesGroup2 || !this.btnStackedSeriesGroup1 || !this.btnStackedSeriesGroup2) { return; }
        if (this.btnEnableSeriesGroup1.checked()) {
