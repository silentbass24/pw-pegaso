...
export class AppComponent implements AfterViewInit {
    ...
    renderAppointment = (data) => {
        ...
        // html - html string
        // view - string
        let img = '<img style="top: 2px; position: relative;" src="assets/img/person.png"/>';
        if (data.appointment.subject == 'Nancy') {
            img = '<img style="top: 2px; position: relative;" src="assets/img/woman.png"/>';
        }
        else if (data.appointment.subject == 'Peter') {
            img = '<img style="top: 2px; position: relative;" src="assets/img/boss.png"/>';
        }
        else if (data.appointment.subject == 'Antony') {
            img = '<img style="top: 2px; position: relative;" src="assets/img/oldboss.png"/>';
        }
        else if (data.appointment.subject == 'John') {
            img = '<img style="top: 2px; position: relative;" src="assets/img/asian.png"/>';
        }
