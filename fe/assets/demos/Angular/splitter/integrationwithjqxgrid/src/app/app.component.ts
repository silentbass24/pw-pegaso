...
@Component({
    selector: 'app-root',
    imports: [jqxSplitterModule, jqxButtonModule, jqxInputModule, jqxGridModule],
    standalone: true,
...
export class AppComponent {
    ...
    rowselect(event: any): void {
        ...
        if (!this.CompanyName || !this.ContactName || !this.ContactTitle || !this.City || !this.Country) { return; }
        // event arguments.
        let args = event.args;
        // selected row.
    ...
    saveClick(): void {
        let row = this.myGrid.getselectedrowindex();
        let rowid = this.myGrid.getrowid(row);
        let data = {
        ...
        this.myGrid.updaterow(rowid, data);
    };
