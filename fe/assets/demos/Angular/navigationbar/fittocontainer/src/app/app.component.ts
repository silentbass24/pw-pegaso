...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        let King = '<div class="bookContainer"><div class="book"><img src="assets/img/Carrie.jpg" /><i>Carrie</i></div><div class="book"><img src="https://www.jqwidgets.com/angular/images/books/Night Shift.jpg" /><i>Night Shift</i></div><div class="book"><img src="assets/img/It.jpg" /><i>It</i></div><div class="book"><img src="https://www.jqwidgets.com/angular/images/books/The Dark Half.jpg" /><i>The Dark Half</i></div></div>';
