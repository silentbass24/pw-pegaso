...
export class AppComponent {
    ...
    sortByListBoxSelect(event: any): void {
        ...
        if (!this.tagCloud || !this.sortByListBox) { return; }
        let args = event.args;
    ...
    sortDirectionListBoxSelect(event: any): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.tagCloud || !this.sortDirectionListBox) { return; }
        let args = event.args;
    ...
    minValueListBoxSelect(event: any): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.tagCloud || !this.minValueListBox) { return; }
        let args = event.args;
    ...
    maxTagsListBoxSelect(event: any): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.tagCloud || !this.maxTagsListBox) { return; }
        let args = event.args;
