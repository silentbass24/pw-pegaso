...
@Component({
    selector: 'app-root',
    imports: [jqxTagCloudModule, jqxDropDownButtonModule, jqxColorPickerModule],
    standalone: true,
...
export class AppComponent implements AfterViewInit {
    ...
    myColorPickerOnColorChange(event: any): void {
        ...
        if (!this.myTagCloud || !this.myDropDownButton1) { return; }
    ...
    myColorPicker2OnColorChange(event: any): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.myTagCloud || !this.myDropDownButton2) { return; }
