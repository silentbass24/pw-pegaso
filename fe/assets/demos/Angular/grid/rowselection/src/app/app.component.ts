...
@Component({
    selector: 'app-root',
    imports: [jqxGridModule, jqxCheckBoxModule, jqxButtonModule, jqxInputModule, jqxDropDownListModule],
    standalone: true,
...
export class AppComponent {
    ...
    enableSelectionOnSelect(event: any): void {
        ...
        if (!this.myGrid || !this.mySelectRowBtn) { return; }
    ...
    myGridOnRowUnselect(event: any): void {
        // the widget raises this while initialising, before @ViewChild is populated
        if (!this.unselectedRowIndex) { return; }
