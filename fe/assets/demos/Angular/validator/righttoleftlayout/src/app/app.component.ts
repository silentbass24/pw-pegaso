...
@Component({
    selector: 'app-root',
    imports: [jqxValidatorModule, jqxInputModule, jqxMaskedInputModule, jqxButtonModule, jqxDateTimeInputModule, jqxPasswordInputModule, jqxCheckBoxModule, jqxExpanderModule],
    standalone: true,
